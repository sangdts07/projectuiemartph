...
import { freshFish, FishCategory } from "@/lib/fish-data"
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-primary-50 to-white">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="inline-block rounded-lg bg-teal-100 px-3 py-1 text-sm text-teal-800 flex items-center gap-1">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                  Premium quality fresh fish caught daily from Philippine waters - experience the true taste of the
                  ocean
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Button className="bg-primary-700 hover:bg-primary-800">Shop All Fresh</Button>
                <Link href="/frozen">
                  <Button variant="outline">View Frozen Fish</Button>
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Browse Fresh Fish</h2>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                Our fresh fish are caught daily and delivered straight to your door
              </p>
            </div>

            <Tabs defaultValue="all" className="mt-8">
              <TabsList className="grid w-full grid-cols-4">
                <TabsTrigger value="all">All Fresh</TabsTrigger>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Why Choose Fresh Fish?</h2>
                <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our fresh fish products offer several advantages for the ultimate seafood experience:
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="rounded-full bg-primary-700 p-1 text-white mt-1">
                      <svg
                    ...
                    <div>
                      <h3 className="font-medium">Superior Taste</h3>
                      <p className="text-gray-500">Experience the true flavor of fish at its freshest</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="rounded-full bg-primary-700 p-1 text-white mt-1">
                    ...
                    <div>
                      <h3 className="font-medium">Maximum Nutrition</h3>
                      <p className="text-gray-500">Retain all the natural nutrients and omega-3 fatty acids</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="rounded-full bg-primary-700 p-1 text-white mt-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">Caught daily and delivered within hours for the best quality</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="rounded-full bg-primary-700 p-1 text-white mt-1">
                    ...
                    <div>
                      <h3 className="font-medium">Versatile Cooking</h3>
                      <p className="text-gray-500">
                        Perfect for all cooking methods from grilling to steaming to raw preparations
                      </p>
                    </div>
                  </li>
                </ul>
